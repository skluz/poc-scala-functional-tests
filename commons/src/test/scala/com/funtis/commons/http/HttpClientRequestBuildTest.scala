...
import com.funtis.commons.json.jackson.SimpleCase
...
class HttpClientRequestBuildTest extends FlatSpec with Matchers with LazyLogging {
  ...
  it should "handle string type body" in {
    new HttpClient.Builder().baseUri("https://www.google.com").body("dupa").buildRequest(Method.POST).body shouldBe new Body(""""dupa"""")
  }
